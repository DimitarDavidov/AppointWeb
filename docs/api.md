...
Requires authentication. Responses use `UserResponse` — password hashes are never returned.
...
**Success response — `200 OK`** — single user object (same shape as list item)
