...
public static class AppointmentRescheduleEmailBuilder
{
    ...
    public static (string HtmlBody, string TextBody) BuildAccepted(
        ...
        string appointmentsUrl)
    {
        ...
        accepterName = CapitalizeFirstLetter(accepterName);

        var textBody =
            $"""
            AppointWeb reschedule accepted

            Hi {recipientName},

            {accepterName} accepted your reschedule request for {serviceName}.
                    ...
                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background-color:#ffffff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(8,145,178,0.12);">
                      <tr>
                        <td style="padding:28px 32px 20px;text-align:center;background:linear-gradient(135deg,#f0fdfa 0%,#ecfeff 45%,#cffafe 100%);border-bottom:1px solid rgba(8,145,178,0.12);">
                          ...
                          <p style="margin:0;font-size:13px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;color:#0891b2;">Reschedule accepted</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:32px;">
                          <h1 style="margin:0 0 12px;font-size:24px;line-height:1.3;color:#334155;">Your reschedule was accepted</h1>
                          <p style="margin:0 0 20px;font-size:16px;line-height:1.6;color:#475569;">
                            Hi {HtmlEncode(recipientName)},<br /><br />
                            <strong style="color:#334155;">{HtmlEncode(accepterName)}</strong> accepted your reschedule request for
                            <strong style="color:#334155;">{HtmlEncode(serviceName)}</strong>.
                          </p>
                          <div style="margin:0 0 20px;padding:16px 18px;border-radius:12px;background-color:#f8fafc;border:1px solid #e2e8f0;">
                            <p style="margin:0 0 10px;font-size:14px;line-height:1.6;color:#475569;">
                              <strong style="color:#334155;">Previous time:</strong> {HtmlEncode(previousWhen)}
                            </p>
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#475569;">
                              <strong style="color:#334155;">New time:</strong> {HtmlEncode(newWhen)}
                            </p>
                          </div>
                          <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 0 24px;">
                            <tr>
                          ...
                          <p style="margin:0;font-size:14px;line-height:1.6;color:#64748b;">
                            Your appointment has been updated to the new time.
                          </p>
                        </td>
                      </tr>
                    </table>
